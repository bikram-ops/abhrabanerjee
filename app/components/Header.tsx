...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between text-white">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="md:hidden px-4 py-2 text-sm bg-blue-600 rounded-xl flex items-center gap-2"
          >
      ...
      {/* MOBILE DRAWER */}
      <div
        className={`fixed top-0 right-0 h-screen w-72 bg-[#0b0b0f]/95 backdrop-blur-2xl 
        border-l border-white/10 px-6 py-20 flex flex-col space-y-6 transition-transform duration-500 z-50
        ...
        {menuItems.map((item) => {
          ...
          return (
            <button
              ...
              disabled={!exists}
              className={`text-lg font-medium py-2 px-3 rounded-lg transition 
                ${
                  exists
                    ? isActive
