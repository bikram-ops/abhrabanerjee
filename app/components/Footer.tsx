...
export default function Footer() {
  return (
    <footer className="bg-[#0b0b0b] py-16 border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
            Founder, storyteller, and brand strategist - transforming brand journeys through performance,
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400 text-sm">
            ...
            <li>
              <a href="https://cmoservices.cleanomatics.com/" target="_blank"
                className="hover:text-white transition">
            ...
            <li>
              <a href="https://www.cleanomaticstech.com" target="_blank"
                className="hover:text-white transition">
            ...
            <li>
              <a href="https://cleanomatics.com" target="_blank"
                className="hover:text-white transition">
  ...
  <div className="flex gap-5 pt-4">
    ...
    >
      ...
      <div className="mt-16 text-center text-gray-500 text-sm border-t border-white/10 pt-6">
        © {new Date().getFullYear()} Abhra Banerjee. All rights reserved. |
        Built by{" "}
        <a
