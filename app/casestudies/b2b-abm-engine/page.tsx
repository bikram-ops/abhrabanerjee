...
//             Case Study: B2B ABM Engine – Account-Based Funnels Powered by Webinars & Pipeline Intelligence
//           </h2>
...
//               <h3 className="text-3xl font-bold text-white">Client Overview</h3>
//               <p className="text-gray-300 leading-relaxed">
//                 A growing B2B SaaS enterprise targeting mid-market and enterprise companies wanted 
//                 to accelerate demand generation and improve pipeline quality. Traditional lead-generation 
//                 tactics brought volume but not high-quality accounts. The company needed a more strategic, 
//                 account-focused growth engine.
//               </p>
//             </motion.div>

//             {/* CHALLENGES */}
//             <motion.div variants={fadeUp} initial="hidden" whileInView="show" className="space-y-6">
//               <h3 className="text-3xl font-bold text-white">Challenges</h3>

//               <div>
//                 <h4 className="text-xl font-semibold text-blue-300">1. Low Engagement from High-Value Accounts</h4>
//                 <p className="text-gray-300 mt-2">ICP accounts were not converting into active opportunities.</p>
//               </div>

//               <div>
//                 <h4 className="text-xl font-semibold text-blue-300">2. No Structured Account-Based Funnel</h4>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>No target account prioritization</li>
//                   <li>No structured nurture</li>
//                   <li>No workflow alignment across teams</li>
//                 </ul>
//               </div>

//               <div>
//                 <h4 className="text-xl font-semibold text-blue-300">3. Weak SDR Handoff Process</h4>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>Delayed responses</li>
//                   <li>Repetitive conversations</li>
//                   <li>Poor meeting-booking rate</li>
//                 </ul>
//               </div>

//               <div>
//                 <h4 className="text-xl font-semibold text-blue-300">4. Lack of Pipeline Intelligence</h4>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>No visibility on hot accounts</li>
//                   <li>Unclear funnel drop-off points</li>
//                   <li>No engagement scoring</li>
//                   <li>No insight into effective touchpoints</li>
//                 </ul>
//               </div>
//             </motion.div>
...
//             {/* SOLUTION */}
//             <motion.div variants={fadeUp} initial="hidden" whileInView="show" className="space-y-6">
//               <h3 className="text-3xl font-bold text-white">Solution Implemented: B2B ABM Engine</h3>

//               {/* Tiering */}
//               <div>
//                 <h4 className="text-xl font-semibold text-blue-300">
//                   1. Target Account Identification & Tiering
//                 </h4>
//                 <p className="text-gray-300 mt-2">Segmented into 3 tiers:</p>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>Tier 1: Enterprise accounts</li>
//                   <li>Tier 2: Mid-market accounts</li>
//                   <li>Tier 3: Scalable SMB segment</li>
//                 </ul>
//                 <p className="text-gray-400 mt-2">Each tier received a tailored level of personalization.</p>
//               </div>

//               {/* Webinar Funnel */}
//               <div>
//                 <h4 className="text-xl font-semibold text-blue-300">
//                   2. Account-Based Funnel with Webinar Touchpoints
//                 </h4>

//                 <h5 className="text-lg font-semibold text-cyan-300 mt-4">Webinar ABM Funnel Stages</h5>

//                 <ul className="list-disc ml-6 text-gray-300 mt-2 space-y-1">
//                   <li><strong>Awareness:</strong> Personalized ads + warming emails</li>
//                   <li><strong>Interest:</strong> Webinar invites tailored to industry pain points</li>
//                   <li><strong>Engagement:</strong> Summary emails, recordings & case studies</li>
//                   <li><strong>Consideration:</strong> Intent pushed to SDRs</li>
//                   <li><strong>Conversion:</strong> SDR outreach → demo → opportunity</li>
//                 </ul>

//                 <h5 className="text-lg font-semibold text-cyan-300 mt-4">Why Webinars?</h5>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>High intent signals</li>
//                   <li>Fits enterprise buying cycle</li>
//                   <li>Scalable and repurposable</li>
...
//               {/* SDR automation */}
//               <div>
//                 <h4 className="text-xl font-semibold text-blue-300">3. SDR Handoff Automation</h4>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2 space-y-1">
//                   <li>Real-time routing of webinar + website leads</li>
//                   <li>Auto-enriched profiles (role, tier, engagement)</li>
//                   <li>SDR playbooks with sequences</li>
//                   <li>Industry-specific messaging</li>
//                 </ul>
//                 <p className="text-gray-400 mt-2">SDRs reached the right accounts at the right moments.</p>
//               </div>

//               {/* Intelligence dashboard */}
//               <div>
//                 <h4 className="text-xl font-semibold text-blue-300">4. Pipeline Intelligence Dashboard</h4>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2 space-y-1">
//                   <li>Account engagement scoring</li>
//                   <li>Multi-channel intent tracking</li>
//                   <li>Funnel stage movement</li>
//                   <li>SDR performance analytics</li>
//                   <li>Flagged high-priority accounts</li>
//                 </ul>
//               </div>
//             </motion.div>
...
//             {/* IMPACT */}
//             <motion.div variants={fadeUp} initial="hidden" whileInView="show" className="space-y-4">
//               <h3 className="text-3xl font-bold text-white">Impact & Results</h3>

//               <ul className="list-disc ml-6 text-gray-300 space-y-3">
//                 <li><strong className="text-cyan-300">📈 3.5× increase</strong> in target account engagement</li>
//                 <li><strong className="text-cyan-300">📈 2× boost</strong> in SDR meeting booking rate</li>
//                 <li><strong className="text-cyan-300">📈 55% faster</strong> pipeline velocity</li>
//                 <li><strong className="text-cyan-300">📈 40% more</strong> Tier-1 opportunities</li>
//                 <li>Improved marketing–sales alignment</li>
//               </ul>
//             </motion.div>
...
//               <p className="text-gray-300 leading-relaxed">
//                 The ABM Engine—powered by webinars, automated SDR workflows, and pipeline intelligence—
//                 transformed their demand generation into a predictable revenue system.
//               </p>

//               <p className="text-gray-300 leading-relaxed">
//                 The company now activates the right accounts at the right time, identifies buying intent early, 
//                 and scales opportunity creation through a repeatable and data-driven ABM model.
//               </p>
//             </motion.div>
