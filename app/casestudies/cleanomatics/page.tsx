...
//           >
//             Case Study: D2C Phygital Transformation for Cleanomatics
//           </h2>
...
//                 Cleanomatics, a premium home-services and laundry brand, wanted to strengthen its 
//                 direct-to-consumer (D2C) presence while standing out in a competitive market.
//               </p>

//               <p className="text-gray-300 leading-relaxed">
//                 The brand needed stronger segmentation, improved customer engagement, and premium 
//                 positioning — built around a robust phygital (physical + digital) ecosystem with the 
//                 mobile app as the central customer touchpoint.
//               </p>
//             </motion.div>
...
//                   1. Weak CRM Segmentation & Low Repeat Usage
//                 </h4>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>No detailed segmentation</li>
//                   <li>No personalized campaigns</li>
//                   <li>No lifecycle visibility</li>
//                 </ul>
//               </div>
...
//                 <p className="text-gray-300 mt-2">All customers received the same notifications & offers:</p>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>Low open rates</li>
//                   <li>Low relevance</li>
//                   <li>Poor off-season conversions</li>
//                 </ul>
//               </div>
...
//               <div>
//                 <h4 className="text-xl font-semibold text-blue-300">
//                   3. No Premium Differentiator
//                 </h4>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>No luxury partnerships</li>
//                   <li>No premium experience layer</li>
//                   <li>Weak premium positioning</li>
//                 </ul>
//               </div>
...
//               <div>
//                 <h4 className="text-xl font-semibold text-blue-300">
//                   4. Offline & Online Systems Not Aligned
//                 </h4>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>Order status mismatches</li>
...
//             <motion.div variants={fadeUp} initial="hidden" whileInView="show" className="space-y-6">
//               <h3 className="text-3xl font-bold text-white">Solution Implemented: D2C Phygital Engine</h3>

//               {/* Segmentation */}
//               <div>
//                 <h4 className="text-xl font-semibold text-blue-300">
//                   1. App-First CRM Segmentation
//                 </h4>

//                 <p className="text-gray-300 mt-2">A deep segmentation model was created:</p>

//                 <h5 className="text-lg font-semibold text-cyan-300 mt-3">Segments Included:</h5>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>New users</li>
//                   <li>High-frequency users</li>
//                   <li>Dormant users</li>
//                   <li>Premium fabric-care customers</li>
//                   <li>Large-order households</li>
//                   <li>Weekend shoppers</li>
//                   <li>Discount-sensitive customers</li>
//                 </ul>

//                 <h5 className="text-lg font-semibold text-cyan-300 mt-3">Segmentation Based On:</h5>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>Order history</li>
//                   <li>Ticket size</li>
//                   <li>App behaviour</li>
//                   <li>Location & outlet proximity</li>
//                 </ul>
//               </div>
...
//                 <p className="text-gray-300 mt-2">Automation-driven journeys were built:</p>

//                 <h5 className="text-lg font-semibold text-cyan-300 mt-3">
//                   Journey Types:
//                 </h5>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>Welcome sequences</li>
//                   <li>Reactivation flows</li>
//                   <li>Premium care journeys</li>
//                   <li>Fabric-specific reminders</li>
//                   <li>Location-based offers</li>
//                   <li>Order anniversary campaigns</li>
//                   <li>Cart abandonment nudges</li>
//                   <li>VIP early-access drops</li>
//                 </ul>

//                 <h5 className="text-lg font-semibold text-cyan-300 mt-3">Cross-Channel Delivery:</h5>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>App notifications</li>
//                   <li>In-app banners</li>
//                   <li>WhatsApp automation</li>
//                   <li>Dynamic couponing</li>
//                 </ul>
//               </div>
...
//                   Exclusive high-end partnerships strengthened Cleanomatics’ premium brand.
//                 </p>

//                 <h5 className="text-lg font-semibold text-cyan-300 mt-3">Examples:</h5>
//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>Premium fabric-care collection</li>
//                   <li>Luxury membership tiers</li>
//                   <li>Seasonal premium-care offers</li>
//                   <li>Exclusive co-branded hampers</li>
//                 </ul>
//               </div>
...
//               <div>
//                 <h4 className="text-xl font-semibold text-blue-300">
//                   4. Phygital Sync of Online & Offline Operations
//                 </h4>

//                 <ul className="list-disc ml-6 text-gray-300 mt-2">
//                   <li>Unified app + outlet order sync</li>
//                   <li>Real-time service updates</li>
//                   <li>Digital-first staff workflow</li>
//                   <li>Automated feedback loops</li>
//                 </ul>

//                 <p className="text-gray-400 mt-2">
//                   The physical experience now perfectly complements the app experience.
//                 </p>
//               </div>
//             </motion.div>
...
//                 <li>
//                   <span className="text-cyan-300 font-semibold">📈 34% Increase in Repeat Orders</span>  
//                   via segmentation + reactivation.
//                 </li>
//                 <li>
//                   <span className="text-cyan-300 font-semibold">📈 52% Higher Notification Engagement</span>  
//                   due to personalization.
//                 </li>
//                 <li>
//                   <span className="text-cyan-300 font-semibold">📈 40% Growth in Premium Ticket Size</span>  
//                   from luxury partnerships.
//                 </li>
//                 <li>Far smoother phygital experience across outlets + app.</li>
//                 <li>Significant elevation in premium brand perception.</li>
//               </ul>
//             </motion.div>
...
//               <p className="text-gray-300 leading-relaxed">
//                 The D2C Phygital Transformation created a unified, app-first digital ecosystem that
//                 strengthened retention, improved brand loyalty, and enabled scalable premium growth.
//               </p>

//               <p className="text-gray-300 leading-relaxed">
//                 With hyper-personalized journeys, advanced segmentation, and luxury collaborations,
//                 Cleanomatics now operates a sustainable, premium D2C model ready for multi-city expansion.
//               </p>
//             </motion.div>
