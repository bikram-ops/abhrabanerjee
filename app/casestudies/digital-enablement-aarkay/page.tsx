...
//         <Header />
//       <section id="case-aarkay" className="py-24">
...
//           >
//             Case Study: Digital Enablement for Aarkay
//           </h1>

//           {/* WRAPPER CARD */}
//           <div
//             className="bg-white/5 backdrop-blur-xl border border-white/10 
//             rounded-3xl shadow-[0_0_40px_rgba(0,150,255,0.08)] p-10 space-y-12"
//           >

//             {/* CLIENT OVERVIEW */}
//             <motion.div variants={fadeUp} initial="hidden" whileInView="show" className="space-y-4">
//               <h2 className="text-3xl font-bold text-white">Client Overview</h2>
//               <p className="text-gray-300 leading-relaxed">
//                 Aarkay is a growing organization focused on sales-driven services.
//                 With increasing inquiries and prospects, the team struggled to manage
//                 lead flow, follow-ups, and customer engagement effectively.
//                 Manual processes slowed the sales cycle and led to missed opportunities.
//               </p>
//             </motion.div>
...
//                     <li>Lead sources were not centralized (WhatsApp, website, email, calls)</li>
//                     <li>Delayed responses</li>
//                     <li>Lead misplacement</li>
...
//                     <li>Missed follow-up cycles</li>
//                     <li>Inconsistent nurturing</li>
//                   </ul>
//                 </div>
...
//                   </h3>
//                   <ul className="list-disc ml-6 text-gray-400 mt-2">
//                     <li>No lead status visibility</li>
//                     <li>No clarity on sales performance</li>
//                     <li>No tracking of follow-up quality</li>
//                     <li>Poor visibility into team productivity</li>
//                   </ul>
//                 </div>
...
//                     Due to all the above issues, the conversion rate remained low and unpredictable.
//                   </p>
//                 </div>
...
//             {/* SOLUTION */}
//             <motion.div variants={fadeUp} initial="hidden" whileInView="show" className="space-y-6">
//               <h2 className="text-3xl font-bold text-white">Solution Implemented</h2>

//               <div className="space-y-6 text-gray-300">

//                 <div>
//                   <h3 className="text-xl font-semibold text-blue-300">
//                     1. Zoho CRM Setup & Customization
//                   </h3>
//                   <ul className="list-disc ml-6 text-gray-400 mt-2">
//                     <li>Centralized all lead sources (Website, WhatsApp, Facebook Ads, Email, Calls)</li>
//                     <li>Custom CRM modules matching Aarkay workflow</li>
//                     <li>Lead scoring model configured</li>
//                   </ul>
//                 </div>
...
//                     <li>AI-based follow-up reminders</li>
//                     <li>Automated nurturing email sequences</li>
//                     <li>Auto alerts for inactive leads</li>
//                     <li>AI-generated summaries for faster decisions</li>
//                   </ul>
//                 </div>

//                 <div>
//                   <h3 className="text-xl font-semibold text-blue-300">
//                     3. Follow-Up Flow Creation
//                   </h3>
//                   <ul className="list-disc ml-6 text-gray-400 mt-2">
//                     <li>Day 1: Instant auto-response + call reminder</li>
//                     <li>Day 2–5: WhatsApp + email drip automation</li>
//                     <li>Weekly: AI-based check-ins for cold leads</li>
//                   </ul>
//                 </div>
...
//                   </h3>
//                   <ul className="list-disc ml-6 text-gray-400 mt-2">
//                     <li>Lead funnel insights</li>
//                     <li>Team performance analytics</li>
//                     <li>Conversion & follow-up metrics</li>
//                     <li>Weekly trend insights</li>
//                   </ul>
//                 </div>
...
//                 <li><strong className="text-cyan-300">68% increase</strong> in lead conversions</li>
//                 <li><strong className="text-cyan-300">70% faster</strong> response time</li>
//                 <li><strong className="text-cyan-300">95% consistent</strong> follow-up cycle</li>
//                 <li>Higher team productivity</li>
//                 <li>Complete visibility for managers</li>
//               </ul>
//             </motion.div>
...
//               <p className="text-gray-300 leading-relaxed">
//                 The Zoho + AI digital enablement program transformed Aarkay’s sales operations
//                 into a highly efficient, automated, and scalable system. With AI assistance and
//                 streamlined workflows, the team now closes more leads with less effort.
//               </p>
//             </motion.div>
